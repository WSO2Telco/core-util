...
package com.wso2telco.core.sp.config.utils.dao;
...
public interface SpConfigDAO {
    ...
    void delete(Config config) throws Exception;

    List<String> getScopes(String clientId) throws Exception;

    List<String> getMessages(String clientId) throws Exception;
