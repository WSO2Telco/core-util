...
public interface OauthAdminService {
    ...
    boolean rebuildOAuthApplicationData(AdminServiceDto adminServiceDto, OAuthConsumerAppDTO oAuthConsumerAppDTO)
            throws SpProvisionServiceException;

    OAuthConsumerAppDTO getOAuthApplicationData(AdminServiceDto adminServiceDto)
            throws SpProvisionServiceException;
    
    boolean isCredentailsEquals(AdminServiceDto adminServiceDto, OAuthConsumerAppDTO oAuthConsumerAppDTO)
            throws SpProvisionServiceException;
}
